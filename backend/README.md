...
## Project Structure
    ...
    ├── passwordgenerator_32731  # Django project configurations
...
1. Clone this repo and `cd passwordgenerator_32731`
...
2. Clone this repo and `cd passwordgenerator_32731`
